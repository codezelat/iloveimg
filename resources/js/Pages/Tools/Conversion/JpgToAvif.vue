<template>
    <BaseToolPage
        ...
        file-type-label="JPG/JPEG images"
        ...
        <template #options>
            <div class="space-y-4 p-4 rounded-2xl border border-white/10 bg-white/5">
                ...
                <p class="text-xs text-white/60">
                    AVIF provides superior compression. {{ quality <= 50 ? 'Low quality for web optimization.' : quality <= 75 ? 'Good balance of quality and size.' : 'High quality with still great compression.' }}
                </p>
            </div>
        </template>
    </BaseToolPage>
